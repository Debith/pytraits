...
2.0.0 (2016-DEC-12)
-------------------
  - Renaming library to pytraits, combining py2traits and pytraits
  - Adding support to Python 2
  - Removing type_safe, type_validation and type_converted (not considered part of the lib)
...
0.10.0 (2015-03-30)
-------------------
  - Splitting into two projects: py2traits and pytraits
